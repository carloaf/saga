        ...
        <div class="w-full sm:max-w-lg mt-6 px-6 py-4 bg-white shadow-md overflow-hidden sm:rounded-lg">
            ...
            <form method="POST" action="{{ route('auth.register') }}">
                ...
                <div class="grid grid-cols-1 gap-4">
                    ...
                    <div>
                        ...
                        <div class="mt-2 space-y-2">
                            <div class="flex items-center">
                                ...
                                >
                                <label for="male" class="ml-2 block text-sm text-gray-900">Masculino</label>
                            </div>
                            <div class="flex items-center">
                                <input 
                                    id="female" 
                                    ...
                                    class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300"
                                >
                                <label for="female" class="ml-2 block text-sm text-gray-900">Feminino</label>
                            </div>
                        </div>
                    </div>
                    ...
                    <div>
                        <label for="ready_at_om_date" class="block text-sm font-medium text-gray-700">Data de Apresentação na OM</label>
                        <input 
                            id="ready_at_om_date" 
